...
namespace SerialCommunication
{
    class ModbusCRC16
    {
        ...
        private static byte uniteBytes(byte src0, byte src1)
        {
            ...
            byte _b0 = byte.Parse(System.Text.Encoding.Default.GetString(new byte[] { src0 }), NumberStyles.HexNumber);

            _b0 = (byte)(_b0 << 4);

            byte _b1 = byte.Parse(System.Text.Encoding.Default.GetString(new byte[] { src1 }), NumberStyles.HexNumber);
        ...
        private static byte[] HexString2Buf(String src)
        {
            ...
            byte[] tmp = System.Text.Encoding.Default.GetBytes(src);
